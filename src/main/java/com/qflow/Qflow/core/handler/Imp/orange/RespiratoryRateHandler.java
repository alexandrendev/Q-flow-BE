...
public class RespiratoryRateHandler extends PrioritySuggestionHandler {
    @Override
    public ManchesterPriority handleRequest(TriageForm form) {
        if (form.respiratoryRate() < 10 || form.respiratoryRate() > 30) return ManchesterPriority.VERY_URGENT;
